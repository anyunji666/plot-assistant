...
\`\`\`
Step1 存量清理：旧条目已兑现/作废/不可能再被履行 → 角色名·关键词: [REMOVE]
Step2 新增：本轮正文及 <private_letter name="角色名"> 标签包裹的当日私信中，是否出现双方或多方已明确达成、尚未兑现的约定（比如约好的见面/时限/交易/条件）？
    以下情况不记录：
      - 单纯的意图/打算（"她想...""他计划..."），只有单方想法、未与人约定的不记 → 需要记录的是已达成共识的事实
      - 单纯关系状态变化 / 纯事件叙述 / 本轮内已兑现的约定
Step3 格式：角色名·关键词: (日期·地点)+一句话说明约定内容；（日期具体到年月日，整体不超30字）
\`\`\`
...
Agreements: {{user}}·城南集市之约: (武定三年三月十五·云隐山)与角色A约好三日后在城南集市碰面；角色A·旧日承诺: [REMOVE]
\`\`\``;
