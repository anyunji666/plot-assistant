...
import { RELATIONSHIP_STAGE_WORDS } from "./parser.js";
...
// 阶段词表直接从 parser.js 的 RELATIONSHIP_STAGE_WORDS 动态拼，不在文案里手写第二份，
// 避免以后词表改了这里忘记同步。
...
export async function openPromptTemplateFormatDialog() {
  ...
  await new Promise((resolve) => {
    ...
    const bodyText =
      ...
      "\n" +
      "初始阶段词必填 {{user}}→林某: 室友(陌生)；之后阶段词可一步一步升级为 相识、相熟、好感、暧昧、亲密、恋人。\n" +
