...
import { extension_settings } from "../../../../../../extensions.js"; // 同级参照 status-llm/store.js 的路径深度

// =====================================================================================
// 提示词模板联动模块 - 设置读写：只有一个开关状态，存进 extension_settings（全局设置，
// 随酒馆账号走，不跟随单个角色卡/对话），风格跟 holiday/settings.js 一致。
//
// stageVarSyncEnabled 控制的是 modules/summary/status-table.js 里 syncRelationshipStagesToVariables()
// 是否执行 /setvar 同步"阶段_角色名"变量——真正的同步逻辑写在 status-table.js（跟状态表解析耦合较深，
