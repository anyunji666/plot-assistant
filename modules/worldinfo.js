        ...
        <li id="lorebook-entry-${displayUid}" class="lorebook-entry" style="margin-bottom: 5px; padding: 3px 8px; border-radius: 6px; background: #333; ${
          ...
          <div class="entry-content" style="display: none; margin-top: 8px;">
            <div style="position: relative;">
              <textarea class="entry-textarea" style="width: 100%; min-height: 100px; background: #000000; color: #ffffff; border: 1px solid #444; border-radius: 4px; padding: 8px; font-size: 13px; margin-bottom: 8px;">${sanitizedContent}</textarea>
