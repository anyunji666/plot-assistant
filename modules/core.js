...
// 拼接在提示词开头，作为背景参考资料（比如作息时间表），供 AI 判断角色此刻状态/是否方便回复用；
// 角色扮演指令、人设/最新正文/私信历史块、输出格式要求都写死在代码里，不放进这段可编辑文本。
// 默认留空，不预置具体场景的示例内容，由用户按自己的剧情背景自行填写。
export const DEFAULT_PHONE_PRESET_CONTENT = "";
