        ...
        <div style="margin-bottom: 20px;">
          ...
          <div style="display: flex; flex-direction: column; gap: 8px;">
            ...
            <div style="display: flex; flex-direction: column; gap: 4px;">
              ...
              <select id="${POPUP_ID}-novel-active-chapter" ${novelChapters.length === 0 ? "disabled" : ""} style="width: 100%; box-sizing: border-box; padding: 8px 10px; border-radius: 4px; border: 1px solid #3a3a3a; background: #ffffff; color: #000000; color-scheme: light; font-size: 13px; font-family: inherit;">${buildNovelActiveChapterOptionsHtml(novelChapters, activeNovelChapterUid)}</select>
            </div>
          </div>
        </div>
